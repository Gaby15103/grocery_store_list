...
class _MainLayoutState extends State<MainLayout> with WidgetsBindingObserver {
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () async {
              ...
              try {
                await groupCtrl.createGroup(name);
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (selectedEmails.isNotEmpty) ...[
                      ...
                      const Text("Selected to Invite:", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 12)),
                      const SizedBox(height: 8),
                      Wrap(
                        spacing: 8.0,
                        runSpacing: 4.0,
                        children: selectedEmails.map((email) {
                          return InputChip(
                            ...
                            onDeleted: () => setDialogState(() => selectedEmails.remove(email)),
  ...
  Widget build(BuildContext context) {
    ...
    final bool canShowBack = widget.showBackButton && Navigator.canPop(context);
        ...
        actions: [
          if (activeGroup.id.isNotEmpty)
            IconButton(
              ...
              onPressed: () => _handleShareAction(context, activeGroup, groupCtrl.activeGroupId!),
            ),
          ...?widget.actions,
        ],
        ...
        child: ListView(
          ...
          children: [
            DrawerHeader(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 10),
                  const Text('Grocery Master', style: TextStyle(color: Colors.white, fontSize: 24)),
                  if (authCtrl.isLoggedIn)
                    Text(authCtrl.userProfile?.email ?? "", style: const TextStyle(color: Colors.white70, fontSize: 12)),
                ],
              ),
            ),
            ListTile(
                      ...
                      if (newValue != null) {
                        ...
                        if (mounted) {
                          ...
                          Navigator.pushReplacement(context, MaterialPageRoute(
                            builder: (context) => ListSelectionView(groupId: newValue),
                          ));
                        }
                      }
                    },
            ...
            ListTile(
              ...
              subtitle: Text('Account: ${authCtrl.userProfile?.email ?? "Not Linked"}'),
              onTap: () {
                Navigator.pop(context);
