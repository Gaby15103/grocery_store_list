...
import { View, Text, StyleSheet, ScrollView, TextInput, Pressable, Alert, Clipboard, Platform } from 'react-native';
...
export default function SettingsScreen() {
    ...
    const handleSaveProfile = async () => {
        try {
            ...
            Alert.alert("Erreur", "Impossible de mettre le profil à jour.");
        }
    };
    ...
    const handleFactoryReset = () => {
        Alert.alert(
            t('danger_zone'),
            "Êtes-vous certain de vouloir tout effacer ? Cette action vous déconnectera définitivement.",
            [
    ...
    return (
        ...
        >
            ...
            <View style={[styles.card, { backgroundColor: colors.card, borderColor: colors.border }]}>
                ...
                <Pressable
                    style={({ pressed }) => [[styles.primaryButton, { backgroundColor: colors.primary }], pressed && styles.btnPressed]}
            ...
            <View style={[styles.card, { backgroundColor: colors.card, borderColor: colors.border }]}>
                <View style={styles.syncRow}>
                    ...
                    <Pressable style={[styles.iconActionBtn, { backgroundColor: colors.background }]} onPress={() => copyToClipboard(auth.syncCode)}>
                        <Copy size={20} color={colors.text} />
                    </Pressable>
                </View>
                <View style={[styles.divider, { backgroundColor: colors.border }]} />
                <Pressable style={styles.syncRowClickable} onPress={() => {/* Code prompt modal */}}>
